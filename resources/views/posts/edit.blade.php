...
@section('content')
    {{-- input type="file"　を使うなら enctype="multipart/form-data" が必要 --}}
    <form action="{{ route('post.update', $post->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea name="body" id="body" rows="5" class="form-control" placeholder="Stert writing...">{{ old('body', $post->body) }}</textarea>
